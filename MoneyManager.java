...
class MoneyManager {
    int moneyin;
    int quarter, nickel, dime, onedollar, fivedollar, tendollar, twentydollar;
    static int minquarter, minnickel, mindime, minonedollar, minfivedollar, mintendollar, mintwentydollar;
    public MoneyManager()
    {
        moneyin = 0;
